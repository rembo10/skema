...
export function ServerTab({
  ...
  const displayedApiKey = config.server.api_key;
      ...
      <div className="card">
        <div className="px-6 py-5 border-b border-dark-border">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-lg font-medium text-dark-text">API Key</h2>
              <p className="mt-1 text-sm text-dark-text-secondary">
                Generate an API key for external access via the X-API-Key header
              </p>
            </div>
            {config.server.api_key_enabled && (
        ...
        <div className="px-6 py-5 space-y-4">
          {displayedApiKey && (
            <div className="flex items-center gap-3 rounded-lg bg-dark-bg-subtle border border-dark-border p-3">
              <code className="flex-1 text-sm text-dark-text font-mono break-all">{displayedApiKey}</code>
              <button
                type="button"
